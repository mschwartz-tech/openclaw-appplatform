...
- Follows progressive deployment stages (App Platform service → Tailscale)
...
2. Run: openclaw gateway health --url ws://127.0.0.1:8080
...
## Stage 2: Production with Tailscale ($25/mo)
